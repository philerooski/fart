/***
 * f of art - paint with math by manipulating parametric equations in real-time as they are being drawn
 *
 * - drag variable values to quickly change value 
 * - hold down corresponding variable key on keyboard and move mouse up or down to change value gradually
 * - check the draw instantly box to instantly see the result of your equation
 *
 * Author: Phil Snyder
 */

// keeping these global makes life much easier for this legacy code
var ctx;
var t;
var dt;
var x;
